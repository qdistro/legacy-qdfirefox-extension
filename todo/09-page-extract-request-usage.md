# 09 — How to use `page.extract.request`
...
- `../../qdchrome-extension/todo/08-page-extract-request-usage.md` — same doc on the chrome side.
- `../../qdistro/todo/browser/02-page-extract-request-usage.md` — same doc on the bridge side (canonical).
- [08-bridge-protocol-alignment.md](08-bridge-protocol-alignment.md) — companion alignment effort that wired the bridge's general inbound surface.
